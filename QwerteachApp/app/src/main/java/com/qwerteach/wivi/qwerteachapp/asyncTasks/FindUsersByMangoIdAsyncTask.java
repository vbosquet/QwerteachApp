...
public class FindUsersByMangoIdAsyncTask extends AsyncTask<Object, String, String> {
    ...
    protected String doInBackground(Object... objects) {
        ...
        int authorId = (int) objects[2];
        int creditedUserId = (int) objects[3];
        int transactionId = (int) objects[4];
        ...
        try {
            ...
            URL url = new URL("http://192.168.0.111:3000/api/wallets/find_users_by_mango_id");
